...
Es importarte recordar los objetivos del estudio, uno de ellos guía a la implementación de apropiadas visualizaciones. Para esto se urlizara el software estadístico R, con la puntual  aplicación de paquete "tidyverse". Las visualizaciónes se gestaran con la libreria "ggplot2".
